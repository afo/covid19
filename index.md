...
### Description
Simple analysis of the COVID-19 situation in the Nordic countries. The Nordic countries are not testing broadly, therefore the recorded number of deaths is a more reliable measure to use in order to assess the impact of the disease in each country.
...
The plots are updated daily at 5AM CET (24hr date lag).
